...
> Vai trò `implementer` — stage `implementation` · Gate 4. (`branchType` bugfix → dùng `fixer`.)
...
3. [`../../docs/agents/Implementer.md`](../../docs/agents/Implementer.md) — quy trình chi tiết (nguồn chân lý).
